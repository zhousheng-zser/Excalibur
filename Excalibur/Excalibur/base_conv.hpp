...
namespace glasssix
{
	namespace excalibur
	{
		...
		public:
			...
			baseconv::baseconv(int input_Channel, int output_Channel, int kernelSize, int stride, int pad, bool bias_term, int device)
			{
			...
			baseconv::baseconv(int input_Channel, int output_Channel, int kernelSize, int group, int stride, int pad, bool bias_term, int device)
			{
