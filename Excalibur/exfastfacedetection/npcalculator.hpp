...
namespace glasssix
{
	...
	public:
		...
		//
		std::shared_ptr<tensor<int> > winSize;
		std::shared_ptr<tensor<int> > pixelx;
		std::shared_ptr<tensor<int> > pixely;
		std::shared_ptr<tensor<int> > treeRoot;
		//npd table
		std::shared_ptr<tensor<unsigned char> > fea;
		std::shared_ptr<tensor<unsigned char> > cutpoint;
		std::shared_ptr<tensor<int> > leftChild;
		std::shared_ptr<tensor<int> > rightChild;
		std::shared_ptr<tensor<float> > stageThreshold;
		std::shared_ptr<tensor<float> > fit;
