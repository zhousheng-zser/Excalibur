...
namespace glasssix
{
	...
	{
		Copy_Params(conv1a_weights, Unicorn);
		Copy_Params(conv1a_bias, Unicorn);
		Copy_Params(relu1a_weights, Unicorn);
		Copy_Params(conv1b_weights, Unicorn);
		Copy_Params(conv1b_bias, Unicorn);
		Copy_Params(relu1b_weights, Unicorn);
		Copy_Params(conv2_1_weights, Unicorn);
		Copy_Params(conv2_1_bias, Unicorn);
		Copy_Params(relu2_1_weights, Unicorn);
		Copy_Params(conv2_2_weights, Unicorn);
		Copy_Params(conv2_2_bias, Unicorn);
		Copy_Params(relu2_2_weights, Unicorn);
		Copy_Params(conv2_weights, Unicorn);
		Copy_Params(conv2_bias, Unicorn);
		Copy_Params(relu2_weights, Unicorn);
		Copy_Params(conv3_1_weights, Unicorn);
		Copy_Params(conv3_1_bias, Unicorn);
		Copy_Params(relu3_1_weights, Unicorn);
		Copy_Params(conv3_2_weights, Unicorn);
		Copy_Params(conv3_2_bias, Unicorn);
		Copy_Params(relu3_2_weights, Unicorn);
		Copy_Params(conv3_3_weights, Unicorn);
		Copy_Params(conv3_3_bias, Unicorn);
		Copy_Params(relu3_3_weights, Unicorn);
		Copy_Params(conv3_4_weights, Unicorn);
		Copy_Params(conv3_4_bias, Unicorn);
		Copy_Params(relu3_4_weights, Unicorn);
		Copy_Params(conv3_weights, Unicorn);
		Copy_Params(conv3_bias, Unicorn);
		Copy_Params(relu3_weights, Unicorn);
		Copy_Params(conv4_1_weights, Unicorn);
		Copy_Params(conv4_1_bias, Unicorn);
		Copy_Params(relu4_1_weights, Unicorn);
		Copy_Params(conv4_2_weights, Unicorn);
		Copy_Params(conv4_2_bias, Unicorn);
		Copy_Params(relu4_2_weights, Unicorn);
		Copy_Params(conv4_3_weights, Unicorn);
		Copy_Params(conv4_3_bias, Unicorn);
		Copy_Params(relu4_3_weights, Unicorn);
		Copy_Params(conv4_4_weights, Unicorn);
		Copy_Params(conv4_4_bias, Unicorn);
		Copy_Params(relu4_4_weights, Unicorn);
		Copy_Params(conv4_5_weights, Unicorn);
		Copy_Params(conv4_5_bias, Unicorn);
		Copy_Params(relu4_5_weights, Unicorn);
		Copy_Params(conv4_6_weights, Unicorn);
		Copy_Params(conv4_6_bias, Unicorn);
		Copy_Params(relu4_6_weights, Unicorn);
		Copy_Params(conv4_7_weights, Unicorn);
		Copy_Params(conv4_7_bias, Unicorn);
		Copy_Params(relu4_7_weights, Unicorn);
		Copy_Params(conv4_8_weights, Unicorn);
		Copy_Params(conv4_8_bias, Unicorn);
		Copy_Params(relu4_8_weights, Unicorn);
		Copy_Params(conv4_9_weights, Unicorn);
		Copy_Params(conv4_9_bias, Unicorn);
		Copy_Params(relu4_9_weights, Unicorn);
		Copy_Params(conv4_10_weights, Unicorn);
		Copy_Params(conv4_10_bias, Unicorn);
		Copy_Params(relu4_10_weights, Unicorn);
		Copy_Params(conv4_weights, Unicorn);
		Copy_Params(conv4_bias, Unicorn);
		Copy_Params(relu4_weights, Unicorn);
		Copy_Params(conv5_1_weights, Unicorn);
		Copy_Params(conv5_1_bias, Unicorn);
		Copy_Params(relu5_1_weights, Unicorn);
		Copy_Params(conv5_2_weights, Unicorn);
		Copy_Params(conv5_2_bias, Unicorn);
		Copy_Params(relu5_2_weights, Unicorn);
		Copy_Params(conv5_3_weights, Unicorn);
		Copy_Params(conv5_3_bias, Unicorn);
		Copy_Params(relu5_3_weights, Unicorn);
		Copy_Params(conv5_4_weights, Unicorn);
		Copy_Params(conv5_4_bias, Unicorn);
		Copy_Params(relu5_4_weights, Unicorn);
		Copy_Params(conv5_5_weights, Unicorn);
		Copy_Params(conv5_5_bias, Unicorn);
		Copy_Params(relu5_5_weights, Unicorn);
		Copy_Params(conv5_6_weights, Unicorn);
		Copy_Params(conv5_6_bias, Unicorn);
		Copy_Params(relu5_6_weights, Unicorn);
		Copy_Params(conv5_weights, Unicorn);
		Copy_Params(conv5_bias, Unicorn);
		Copy_Params(relu5_weights, Unicorn);
		//
		device_ = device;
#ifdef USE_CUDA
	...
	void unicorn_net::Forward_native_gpu(const std::shared_ptr<tensor> input_data)
	{
		...
		conv1a->Forward_native_gpu(cublas_handle_, tensor_data, conv1a_top_data);
