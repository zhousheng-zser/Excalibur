...
int main()
{
	...
	{
		tensoroperation::resize_cpu(tensor_mat, tensor_mat, 100, 100, tensoroperation::Nearest);
		...
		//tensoroperation::rgb2gray_cpu(tensor_mat, tensor_mat_gray);
		/*excalibur::tensor<unsigned char>* data;
	...
	cv::Mat show_mat;
	excalibur::tensoroperation::convert2mat(tensor_mat, show_mat);
