...
set(Excalibur_known_gpu_archs "20 21(20) 30 35 50")

function(excalibur_installed_gpus out_variable)
	if(NOT CUDA_gpu_detect_output)
		...
		execute_process(COMMAND "${CUDA_NVCC_EXECUTABLE}" "--run" "${__cufile}"
				...
				PRESULT_VARIABLE __nvcc_res OUTPUT_VARIABLE __nvcc_out
...
function(excalibur_select_nvcc_arch_flags out_variable)
	...
	elseif(${CUDA_ARCH_NAME} STREQUAL "Auto")
		excalibur_detect_installed_gpus(__cuda_arch_bin)
	else()
	...
	excalibur_list_unique(__cuda_arch_bin __cuda_arch_ptx)
...
macro(excalibur_cuda_compile objlist_variable)
