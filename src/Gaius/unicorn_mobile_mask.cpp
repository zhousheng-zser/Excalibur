...
namespace glasssix
{
	namespace gaius
	{
		...
		void Unicorn_mobile_mask::Forward_cpu(const std::shared_ptr<tensor<float>> input_data)
		{
...
#ifdef USE_CUDA
		void Unicorn_mobile_mask::Forward_gpu_native(const std::shared_ptr<tensor<float>> input_data)
		{
...
#ifdef USE_CUDNN
		void Unicorn_mobile_mask::Forward_gpu_cudnn(const std::shared_ptr<tensor<float>> input_data)
		{
