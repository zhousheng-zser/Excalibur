...
namespace glasssix
{
	namespace longinus
	{
		...
		void Face_nir_net::Forward_cpu(const std::shared_ptr<tensor<float>> input_data)
		{
...
#ifdef USE_CUDA
		void Face_nir_net::Forward_gpu_native(const std::shared_ptr<tensor<float>> input_data)
		{
...
#ifdef USE_CUDNN
		void Face_nir_net::Forward_gpu_cudnn(const std::shared_ptr<tensor<float>> input_data)
		{
