...
namespace glasssix
{
	namespace longinus
	{
		Face_nir_net::Face_nir_net(int device)
		{
			device_ = device;
			if (device_ >= 0)
			{
			...
			Copy_Params(conv1_dw_weights, face_nir_net, quantize_level);
			Copy_Params(conv1_dw_bias, face_nir_net, quantize_level);
			Copy_Params(prelu1_dw_weights, face_nir_net, quantize_level);
			Copy_Params(conv2_weights, face_nir_net, quantize_level);
			Copy_Params(conv2_bias, face_nir_net, quantize_level);
			Copy_Params(conv2_dw_weights, face_nir_net, quantize_level);
			Copy_Params(conv2_dw_bias, face_nir_net, quantize_level);
			Copy_Params(prelu2_dw_weights, face_nir_net, quantize_level);
			Copy_Params(conv3_weights, face_nir_net, quantize_level);
			Copy_Params(conv3_bias, face_nir_net, quantize_level);
			Copy_Params(conv3_dw_weights, face_nir_net, quantize_level);
			Copy_Params(conv3_dw_bias, face_nir_net, quantize_level);
			Copy_Params(prelu3_dw_weights, face_nir_net, quantize_level);
			Copy_Params(conv4_weights, face_nir_net, quantize_level);
			Copy_Params(conv4_bias, face_nir_net, quantize_level);
			Copy_Params(conv4_dw_weights, face_nir_net, quantize_level);
			Copy_Params(conv4_dw_bias, face_nir_net, quantize_level);
			Copy_Params(prelu4_dw_weights, face_nir_net, quantize_level);
			Copy_Params(conv5_weights, face_nir_net, quantize_level);
			Copy_Params(conv5_bias, face_nir_net, quantize_level);
			Copy_Params(prelu5_weights, face_nir_net, quantize_level);
			Copy_Params(conv6_1_weights, face_nir_net, quantize_level);
			Copy_Params(conv6_1_bias, face_nir_net, quantize_level);
		...
		void Face_nir_net::Forward_cpu(const std::shared_ptr<memory::tensor<float>> input_data)
		{
...
#ifdef USE_CUDA
		void Face_nir_net::Forward_gpu_native(const std::shared_ptr<memory::tensor<float>> input_data)
		{
...
#ifdef USE_CUDNN
		void Face_nir_net::Forward_gpu_cudnn(const std::shared_ptr<memory::tensor<float>> input_data)
		{
