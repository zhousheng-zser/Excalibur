...
int main()
{
	...
	/*excalibur::pipeline<float>* p = new excalibur::pipeline<float>("D:\\Excalibur\\models\\mobile_unicorn.phai",
	...
	excalibur::pipeline<float> p = excalibur::pipeline<float>("D:\\Excalibur\\models\\unicorn.phai",
		"D:\\Excalibur\\models\\unicorn.racy", -1); 
	...
	/*excalibur::pipeline<float>* p = new excalibur::pipeline<float>("D:\\Excalibur\\models\\retina.phai",
		"D:\\Excalibur\\models\\retina.racy", -1);*/

	std::shared_ptr<memory::tensor<float>> temp;
	p.enable_profiler();
	cv::Mat img = cv::imread("D:\\Excalibur\\imgs\\yswinfread.jpg");

	////cv::Mat img = cv::imread("D:\\Excalibur\\imgs\\480p2.jpg");
	...
	//auto res = p->get_featmap("conv5_gdc");
