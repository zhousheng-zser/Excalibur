	...
	{ \
			...
			int sgemm_AnoTrans_Btrans_special(int M, int N, int K, const float* A, int lda, const float* Bt, int ldb, float* C, int ldc)
		{
			...
			if (K == 16)
			{
				...
				{
					SWAP_A_Bt;
					sgemm_align128bit_AnoTrans_Btrans_M4_N4(M, N, K, A, lda, Bt, ldb, C, ldc);
					handled = 1;
					SWAP_C;
				}
			}
			else if (K == 24)
			{
				...
				{
					SWAP_A_Bt;
					sgemm_align128bit_AnoTrans_Btrans_M2_N8(M, N, K, A, lda, Bt, ldb, C, ldc);
					handled = 1;
					SWAP_C;
				}
			}
...
#if __ARM_NEON_ARMV8
		void sgemm_AnoTrans_Btrans_auto(int M, int N, int K, const float* A, int lda, const float* Bt, int ldb, float* C, int ldc)
		{
			const float* oldA = A, * oldB = Bt;
			float* old_C = C;
			int old_lda = lda, old_ldb = ldb, old_ldc = ldc, old_M = M, old_N = N;
		...
		void sgemm_AnoTrans_Btrans_auto(int M, int N, int K, const float* A, int lda, const float* Bt, int ldb, float* C, int ldc)
		{
			...
			if (K == 16)
			{
				...
				{
					SWAP_A_Bt;
					sgemm_align128bit_AnoTrans_Btrans_M4_N1(M, N, K, A, lda, Bt, ldb, C, ldc);
					handled = 1;
					SWAP_C;
				}
			}
			...
			else if (K == 72) // 3*3*8
			{
				...
				{
					SWAP_A_Bt;
					sgemm_align128bit_AnoTrans_Btrans_M4_N2(M, N, K, A, lda, Bt, ldb, C, ldc);
					handled = 1;
					SWAP_C;
				}
				else if (N <= 128)
			...
			void sgemm_AnoTrans_Btrans_auto(int M, int N, int K, const float* A, int lda, const float* Bt, int ldb, float* C, int ldc)
		{
			...
			if (K == 16)
			{
				if (N >= 8)
				{
					sgemm_align128bit_AnoTrans_Btrans_M2_N4(M, N, K, A, lda, Bt, ldb, C, ldc);
					handled = 1;
				}
			}
			else if (K == 27) //3*3*3
			{
				...
				{
					sgemm_align128bit_AnoTrans_Btrans_M1_N4(M, N, K, A, lda, Bt, ldb, C, ldc);
					handled = 1;
				}
			}
			else if (K == 28)
			...
			else if (K == 32)
			{
				if (N >= 8)
				{
					sgemm_align256bit_AnoTrans_Btrans_M2_N4(M, N, K, A, lda, Bt, ldb, C, ldc);
					handled = 1;
				}
			}
			else if (K == 64)
			{
				if (N >= 8)
				{
					sgemm_align256bit_AnoTrans_Btrans_M4_N2(M, N, K, A, lda, Bt, ldb, C, ldc);
					handled = 1;
				}
			}
			else if (K == 72) // 3*3*8
			...
			else if (K == 256)
			{
				if (N >= 8)
				{
					sgemm_align256bit_AnoTrans_Btrans_M8_N1(M, N, K, A, lda, Bt, ldb, C, ldc);
					handled = 1;
				}
			}
			else if (K == 512)
			...
			if (handled == 0)
			{
				...
				{
					sgemm_align256bit_AnoTrans_Btrans_M4_N4(M, N, K, A, lda, Bt, ldb, C, ldc);
					handled = 1;
				}
			}
			...
			else if (K == 256)
			{
				if (N >= 256)
				{
					sgemm_align128bit_AnoTrans_Btrans_M8_N1(M, N, K, A, lda, Bt, ldb, C, ldc);
					handled = 1;
				}
			}
			else if (K == 512)
...
#else
			sgemm_align0_AnoTrans_Btrans(M, N, K, A, lda, Bt, ldb, C, ldc);
#endif
