...
namespace glasssix
{
	namespace longinus
	{
		rnet_mobile_nir::rnet_mobile_nir(int device)
		{
			device_ = device;
			if (device_ >= 0)
			{
			...
			Copy_Params(conv1_weights, RNet_mobile_nir, quantize_level);
			Copy_Params(conv1_bias, RNet_mobile_nir, quantize_level);
			Copy_Params(prelu1_weights, RNet_mobile_nir, quantize_level);
			Copy_Params(conv2_sep_weights, RNet_mobile_nir, quantize_level);
			Copy_Params(conv2_sep_bias, RNet_mobile_nir, quantize_level);
			Copy_Params(prelu2_weights, RNet_mobile_nir, quantize_level);
			Copy_Params(conv3_sep_weights, RNet_mobile_nir, quantize_level);
			Copy_Params(conv3_sep_bias, RNet_mobile_nir, quantize_level);
			Copy_Params(prelu3_weights, RNet_mobile_nir, quantize_level);
			Copy_Params(conv4_dw_weights, RNet_mobile_nir, quantize_level);
			Copy_Params(conv4_dw_bias, RNet_mobile_nir, quantize_level);
			Copy_Params(prelu4_dw_weights, RNet_mobile_nir, quantize_level);
			Copy_Params(conv4_sep_weights, RNet_mobile_nir, quantize_level);
			Copy_Params(conv4_sep_bias, RNet_mobile_nir, quantize_level);
			Copy_Params(prelu4_weights, RNet_mobile_nir, quantize_level);
			Copy_Params(conv5_dw_weights, RNet_mobile_nir, quantize_level);
			Copy_Params(conv5_dw_bias, RNet_mobile_nir, quantize_level);
			Copy_Params(prelu5_dw_weights, RNet_mobile_nir, quantize_level);
			Copy_Params(conv5_1_weights, RNet_mobile_nir, quantize_level);
			Copy_Params(conv5_1_bias, RNet_mobile_nir, quantize_level);
			Copy_Params(conv5_1_bn_weights, RNet_mobile_nir, quantize_level);
			Copy_Params(conv5_1_bn_bias, RNet_mobile_nir, quantize_level);
			Copy_Params(conv5_1_sc_weights, RNet_mobile_nir, quantize_level);
			Copy_Params(conv5_1_sc_bias, RNet_mobile_nir, quantize_level);
			Copy_Params(conv5_2_weights, RNet_mobile_nir, quantize_level);
			Copy_Params(conv5_2_bias, RNet_mobile_nir, quantize_level);
			Copy_Params(conv5_2_bn_weights, RNet_mobile_nir, quantize_level);
			Copy_Params(conv5_2_bn_bias, RNet_mobile_nir, quantize_level);
			Copy_Params(conv5_2_sc_weights, RNet_mobile_nir, quantize_level);
			Copy_Params(conv5_2_sc_bias, RNet_mobile_nir, quantize_level);
		...
		rnet_mobile_nir::~rnet_mobile_nir()
		{
			delete conv1;
			delete prelu1;
			delete pool1;
			...
			aligned_heap_free(prelu5_dw_weights);
