...
namespace glasssix
{
	namespace longinus
	{
		...
		void rnet_mobile::Forward_cpu(const std::shared_ptr<memory::tensor<float>> input_data)
		{
...
#ifdef USE_CUDA
		void rnet_mobile::Forward_gpu_native(const std::shared_ptr<memory::tensor<float>> input_data)
		{
...
#ifdef USE_CUDNN
		void rnet_mobile::Forward_gpu_cudnn(const std::shared_ptr<memory::tensor<float>> input_data)
		{
...
#endif
#endif
		void rnet_mobile::Forward(const std::shared_ptr<memory::tensor<float>> input_data)
		{
			if (device_<0)
			{
