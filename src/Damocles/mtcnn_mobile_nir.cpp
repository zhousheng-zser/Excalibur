...
glasssix::longinus::mtcnn_mobile_nir::mtcnn_mobile_nir(int device_id, bool handle_big_face)
{
	...
	PNet_ = new pnet_mobile_nir(device_id_);
	RNet_ = new rnet_mobile_nir(device_id_);
	ONet_ = new onet_mobile_nir(device_id_);

	handle_big_face_ = handle_big_face;
}

glasssix::longinus::mtcnn_mobile_nir::~mtcnn_mobile_nir()
{
	delete PNet_;
	delete RNet_;
	delete ONet_;
