...
namespace glasssix
{
	namespace longinus
	{
		...
		void pnet_mobile::Forward_cpu(const std::shared_ptr<tensor<float>> input_data)
		{
...
#ifdef USE_CUDA
		void pnet_mobile::Forward_gpu_native(const std::shared_ptr<tensor<float>> input_data)
		{
...
#ifdef USE_CUDNN
		void pnet_mobile::Forward_gpu_cudnn(const std::shared_ptr<tensor<float>> input_data)
		{
		...
		void pnet_mobile::Forward(const std::shared_ptr<tensor<float>> input_data)
		{
			if (device_<0)
			{
