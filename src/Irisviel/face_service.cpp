...
namespace glasssix
{
	namespace irisviel
	{
		...
		face_service::face_service(int single_database_capacity, int dimension, std::string_view working_directory) : impl_{ new impl{ single_database_capacity, dimension, utils::path_from_string_view(working_directory) } }
		{
		}
