...
namespace glasssix
{
	namespace longinus
	{
		onet_mobile::onet_mobile(int device)
		{
			...
			Copy_Params(relu1_weights, ONet_mobile, quantize_level);
			Copy_Params(conv1_dw_weights, ONet_mobile, quantize_level);
			Copy_Params(conv1_dw_bias, ONet_mobile, quantize_level);
			Copy_Params(relu1_dw_weights, ONet_mobile, quantize_level);
			Copy_Params(conv2_ex_weights, ONet_mobile, quantize_level);
			Copy_Params(conv2_ex_bias, ONet_mobile, quantize_level);
			Copy_Params(relu2_ex_weights, ONet_mobile, quantize_level);
			Copy_Params(conv2_dw_weights, ONet_mobile, quantize_level);
			Copy_Params(conv2_dw_bias, ONet_mobile, quantize_level);
			Copy_Params(relu2_dw_weights, ONet_mobile, quantize_level);
			Copy_Params(conv2_em_weights, ONet_mobile, quantize_level);
			Copy_Params(conv2_em_bias, ONet_mobile, quantize_level);
			Copy_Params(conv2_1_ex_weights, ONet_mobile, quantize_level);
			Copy_Params(conv2_1_ex_bias, ONet_mobile, quantize_level);
			Copy_Params(relu2_1_ex_weights, ONet_mobile, quantize_level);
			Copy_Params(conv2_1_dw_weights, ONet_mobile, quantize_level);
			Copy_Params(conv2_1_dw_bias, ONet_mobile, quantize_level);
			Copy_Params(relu2_1_dw_weights, ONet_mobile, quantize_level);
			Copy_Params(conv2_1_em_weights, ONet_mobile, quantize_level);
			Copy_Params(conv2_1_em_bias, ONet_mobile, quantize_level);
			Copy_Params(conv3_ex_weights, ONet_mobile, quantize_level);
			Copy_Params(conv3_ex_bias, ONet_mobile, quantize_level);
			Copy_Params(relu3_ex_weights, ONet_mobile, quantize_level);
			Copy_Params(conv3_dw_weights, ONet_mobile, quantize_level);
			Copy_Params(conv3_dw_bias, ONet_mobile, quantize_level);
			Copy_Params(relu3_dw_weights, ONet_mobile, quantize_level);
			Copy_Params(conv3_em_weights, ONet_mobile, quantize_level);
			Copy_Params(conv3_em_bias, ONet_mobile, quantize_level);
			Copy_Params(conv3_1_ex_weights, ONet_mobile, quantize_level);
			Copy_Params(conv3_1_ex_bias, ONet_mobile, quantize_level);
			Copy_Params(relu3_1_ex_weights, ONet_mobile, quantize_level);
			Copy_Params(conv3_1_dw_weights, ONet_mobile, quantize_level);
			Copy_Params(conv3_1_dw_bias, ONet_mobile, quantize_level);
			Copy_Params(relu3_1_dw_weights, ONet_mobile, quantize_level);
			Copy_Params(conv3_1_em_weights, ONet_mobile, quantize_level);
			Copy_Params(conv3_1_em_bias, ONet_mobile, quantize_level);
			Copy_Params(conv4_ex_weights, ONet_mobile, quantize_level);
			Copy_Params(conv4_ex_bias, ONet_mobile, quantize_level);
			Copy_Params(relu4_ex_weights, ONet_mobile, quantize_level);
			Copy_Params(conv4_dw_weights, ONet_mobile, quantize_level);
			Copy_Params(conv4_dw_bias, ONet_mobile, quantize_level);
			Copy_Params(relu4_dw_weights, ONet_mobile, quantize_level);
			Copy_Params(conv4_em_weights, ONet_mobile, quantize_level);
			Copy_Params(conv4_em_bias, ONet_mobile, quantize_level);
			Copy_Params(conv4_1_ex_weights, ONet_mobile, quantize_level);
			Copy_Params(conv4_1_ex_bias, ONet_mobile, quantize_level);
			Copy_Params(relu4_1_ex_weights, ONet_mobile, quantize_level);
			Copy_Params(conv4_1_dw_weights, ONet_mobile, quantize_level);
			Copy_Params(conv4_1_dw_bias, ONet_mobile, quantize_level);
			Copy_Params(relu4_1_dw_weights, ONet_mobile, quantize_level);
			Copy_Params(conv4_1_em_weights, ONet_mobile, quantize_level);
			Copy_Params(conv4_1_em_bias, ONet_mobile, quantize_level);
			Copy_Params(conv5_ex_weights, ONet_mobile, quantize_level);
			Copy_Params(conv5_ex_bias, ONet_mobile, quantize_level);
			Copy_Params(relu5_ex_weights, ONet_mobile, quantize_level);
			Copy_Params(conv5_dw_weights, ONet_mobile, quantize_level);
			Copy_Params(conv5_dw_bias, ONet_mobile, quantize_level);
