...
namespace glasssix
{
	namespace irisviel
	{
		...
		struct knn_search_result
		{
			...
			knn_search_result(knn_mapping_data&& data, float distance_in_percentage) : data{ data }, distance_in_percentage{ distance_in_percentage }
			{
			}
			...
			knn_search_result(knn_search_result&& right)
			{
