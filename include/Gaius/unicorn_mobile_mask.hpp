#ifndef _UNICORN_MOBILE_MASK_HPP_
#define _UNICORN_MOBILE_MASK_HPP_
...
namespace glasssix
{
	namespace gaius
	{
		...
		public:
			Unicorn_mobile_mask(int device);
			virtual ~Unicorn_mobile_mask();
...
#endif //!_UNICORN_MOBILE_MASK_HPP_