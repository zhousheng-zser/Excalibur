#ifndef _CONVDW_3X3S1_CPU_HPP_
#define _CONVDW_3X3S1_CPU_HPP_
...
namespace glasssix
{
	namespace excalibur
	{
		class convdw_3x3s1_cpu : public baseconv
		{
		public:

			convdw_3x3s1_cpu(int input_Channel, int output_Channel, int group, int kernelSize, int stride, int pad, bool bias_term, int device = -1, bool int8_quantization = false);

			virtual ~convdw_3x3s1_cpu() {};
