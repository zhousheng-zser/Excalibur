#pragma once
#ifndef _OPERATION_FLATTEN_HPP_
#define _OPERATION_FLATTEN_HPP_
...
namespace glasssix
{
    namespace excalibur
    {
        ...
        class operation_flatten : public operation<Dtype>
        {
        public:
            operation_flatten(const operation_param &param);
            virtual const char *type() const { return this->params_.type_.c_str(); }
            virtual ~operation_flatten() {}
