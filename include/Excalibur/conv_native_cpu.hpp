...
namespace glasssix
{
	namespace excalibur
	{
		...
		{
		public:
			conv_native_cpu(int input_Channel, int output_Channel, int kernelSize, int stride, int pad, bool bias_term, int device)
				: baseconv(input_Channel, output_Channel, kernelSize, stride, pad, bias_term, device) {}

			conv_native_cpu(int input_Channel, int output_Channel, int kernelSize, int group, int stride, int pad, bool bias_term, int device)
