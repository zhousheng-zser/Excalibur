...
namespace glasssix
{
	namespace excalibur
	{
		...
		public:
			...
			float* U_;
			float* V_;
			float *tile_data, *v_data, *m_data, *result;
			...
			conv_winograd_cpu(int input_Channel, int output_Channel, int kernelSize, int stride, int pad, bool bias_term, int device);

			conv_winograd_cpu(int input_Channel, int output_Channel, int kernelSize, int group, int stride, int pad, bool bias_term, int device);
			...
			{
				*(result + 0) = *(m_data + 0) + *(m_data + 4) + *(m_data + 8) + *(m_data + 1) + *(m_data + 5) + *(m_data + 9) + *(m_data + 2) + *(m_data + 6) + *(m_data + 10);
				*(result + 1) = *(m_data + 1) + *(m_data + 5) + *(m_data + 9) - *(m_data + 2) - *(m_data + 6) - *(m_data + 10) - *(m_data + 3) - *(m_data + 7) - *(m_data + 11);
				*(result + 2) = *(m_data + 4) - *(m_data + 8) - *(m_data + 12) + *(m_data + 5) - *(m_data + 9) - *(m_data + 13) + *(m_data + 6) - *(m_data + 10) - *(m_data + 14);
				*(result + 3) = *(m_data + 5) - *(m_data + 9) - *(m_data + 13) - *(m_data + 6) + *(m_data + 10) + *(m_data + 14) - *(m_data + 7) + *(m_data + 11) + *(m_data + 15);
			}
