...
namespace glasssix
{
	namespace longinus
	{
		class pnet_mobile_nir
		{
			...
			Declear_Params(conv4_1_bn);
			Declear_Params(conv4_1_scale);
			...
			Neuron_Name(conv4_1);
			Declear_Opration(batchnorm_arm, conv4_1_bn);
			Neuron_Name(conv4_1_bn);
			Declear_Opration(scale_arm, conv4_1_scale);
			Neuron_Name(conv4_1_scale);
