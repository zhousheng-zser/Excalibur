#pragma once
#ifndef _GEMM_PROBLEMS_HPP_
#define _GEMM_PROBLEMS_HPP_
#include <tuple>
#include <vector>
...
std::vector<std::tuple<int, int, int, bool, bool>> inference_cassius_set =
{
	...
	std::make_tuple(256, 784, 1152, false, false),
	std::make_tuple(256, 196, 2304, false, false),
	std::make_tuple(512, 144, 2304, false, false),
	std::make_tuple(512, 36, 4608, false, false),
	std::make_tuple(512, 16, 4608, false, false)
};
#endif // !_GEMM_PROBLEMS_HPP_
