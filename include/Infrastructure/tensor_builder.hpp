...
namespace glasssix
{
    namespace excalibur
    {
        ...
        public:
            ...
            virtual void tensor_parameters(memory::orderType order) = 0;
            ...
            virtual void tensor_parameters(memory::orderType order, int device) = 0;
            ...
            /// False: failure
            ///</returns>
            virtual bool from_tensor(const memory::tensor<float>& data, tensor_layout layout) = 0;
            ...
            /// False: failure
            ///</returns>
            virtual bool from_tensor(const memory::tensor<uint8_t>& data, tensor_layout layout) = 0;
            ...
            virtual std::optional<memory::tensor<float>> to_tensor_float(tensor_layout layout) = 0;
            ...
            /// <returns>The result</returns>
            virtual std::optional<memory::tensor<uint8_t>> to_tensor_uint8(tensor_layout layout) = 0;
            ...
            /// <param name="layout">The destintation bitmap type</param>
            /// <returns>The result</returns>
            virtual std::shared_ptr<memory::tensor<float>> to_tensor_float_shared(tensor_layout layout) = 0;
            ...
            /// <param name="layout">The destination bitmap type</param>
            /// <returns>The result</returns>
            virtual std::shared_ptr<memory::tensor<uint8_t>> to_tensor_uint8_shared(tensor_layout layout) = 0;
        };
    }
}
